...
export default function CountdownTimer() {
    ...
    return (
        <div className="flex items-center justify-center p-8 bg-white shadow-lg rounded-3xl max-w-fit" style={{ width: '250px', height: '200px', overflow: 'hidden' }}>
            ...
            {/* Timer Controls */}
            <div className="flex flex-col items-center bg-white max-w-fit">
                <div className="flex space-x-4 bg-white max-w-fit">
                ...
                <h1 className="text-5xl font-bold my-2 bg-white max-w-fit">
            ...
            {/* Play / Stop Buttons */}
            <div className="flex flex-col space-y-2 bg-white max-w-fit">
                ...
                <button onClick={() => { setMinutes(0); setSeconds(0); setIsRunning(false); }}
                    className="border text-2xl p-4 rounded-full max-w-fit">
                    ⏹
                </button>
            </div>
        </div>
